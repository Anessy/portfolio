  ...
  const inVarios = `
          <div class="varius">
            <div class="row">
              <div class="col">
                <div class="numder">
                  <img class="number1" src="${number1}" alt="">
                  <img class="number2" src="${number2}" alt="">
                  <img class="number3" src="${number3}" alt="">
                  <img class="number4" src="${number4}" alt="">
                </div>
              </div>
              <div class="col all">
                <div class="answer" >
                  <img class="answer-img" src="${answer}" alt="" ">
                </div>
              </div>
            </div>
          </div> 
...
function init() {
  getData('./db/lernNumbers.json').then(function(data){ // ф-ция получения данных по запросу. then вызывает ф-цию после получения данных. data - полученные данные (массив)
